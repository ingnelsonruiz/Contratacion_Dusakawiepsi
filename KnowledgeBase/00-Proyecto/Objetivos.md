...
| Objetivo de negocio | Módulo que lo cubre |
|---|---|
...
| Analizar consumos y frecuencias | [[Arquitectura General#Módulo 3 — Consumo y Frecuencia\|Módulo 3: Consumo]] |
| Detectar sobrecostos y oportunidades de ahorro | [[Arquitectura General#Módulo 4 — Sobrecostos y Ahorro\|Módulo 4: Sobrecostos]] |
| Simular escenarios de negociación | [[Arquitectura General#Módulo 5 — Simulador de Escenarios\|Módulo 5: Simulador]] |
| Tener referencia objetiva de mercado externo | [[Arquitectura General#Módulo 6 — Benchmark de Mercado Externo\|Módulo 6: Benchmark]] |
| Apoyar la decisión pre-negociación con indicadores | [[Arquitectura General#Módulo 7 — Dashboard Ejecutivo\|Módulo 7: Dashboard Ejecutivo]] |
| Gobernanza: usuarios, auditoría, calidad de datos | [[Arquitectura General#Módulo 8 — Administración\|Módulo 8: Administración]] |
